...
#define INVERT_X_DIR true // DELTA does invert
...
//#define Z_MIN_PROBE_REPEATABILITY_TEST  // If not commented out, Z Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  #define X_PROBE_OFFSET_FROM_EXTRUDER 12     // X offset: -left  [of the nozzle] +right
  #define Y_PROBE_OFFSET_FROM_EXTRUDER -7   // Y offset: -front [of the nozzle] +behind
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -2.3  // Z offset: -below [the nozzle] (always negative!)
